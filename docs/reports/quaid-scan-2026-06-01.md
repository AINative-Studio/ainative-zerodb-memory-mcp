# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/ainative-zerodb-memory-mcp

**Score:** 🔴 0.8/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.4s
**Scanned:** 2026-06-01T20:57:17.987Z

## Pillar Scores

| Pillar | Score | Weight | Findings |
|--------|-------|--------|----------|
| Security | 0.0 | 25% | 0C 9W 1I |
| Governance | 0.0 | 20% | 1C 2W 11I |
| Community | 0.0 | 15% | 0C 4W 10I |
| AI Readiness | 2.5 | 15% | 0C 5W 0I |
| Inclusive Language | 0.0 | 15% | 0C 5W 13I |
| Technical Rigor | 4.0 | 10% | 0C 3W 3I |
...
- **[dep-pinning-packages-2]** Loosely pinned dependency "axios": "^1.6.0" uses ^ prefix in dependencies *(Consider pinning "axios" to an exact version for reproducible builds)*
- **[dep-pinning-packages-3]** Loosely pinned dependency "dotenv": "^16.4.0" uses ^ prefix in dependencies *(Consider pinning "dotenv" to an exact version for reproducible builds)*
- **[dep-pinning-packages-4]** Loosely pinned dependency "c8": "^9.1.0" uses ^ prefix in devDependencies *(Consider pinning "c8" to an exact version for reproducible builds)*
- **[dep-pinning-packages-5]** No package-lock.json found. Lock files ensure reproducible installs *(Run "npm install" to generate a package-lock.json)*
...
- **[contributor-data-1]** 1 unique contributor with 3 commits in the last 12 months *(Single contributor detected — consider recruiting additional maintainers)*
...
- **[bus-factor-1]** Bus factor: 1, Elephant factor: 100% (1 contributors, 3 commits in last 12 months)
...
- **[vendor-neutrality-domain-count]** Found 1 unique email domain(s) across 3 commits
...
- **[AK-GIT-CLONE-README.md:35]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-CLONE-README.md:36]** Assumed knowledge: "clone" operation used without explanation
- **[AK-TOOL-NPM-README.md:40]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:47]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:514]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:520]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:526]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-ACRONYM-MCP-README.md:1]** Undefined acronym "MCP" may confuse newcomers
- **[AK-ACRONYM-LLM-README.md:16]** Undefined acronym "LLM" may confuse newcomers
- **[AK-ACRONYM-BAAI-README.md:22]** Undefined acronym "BAAI" may confuse newcomers
- **[AK-ACRONYM-BGE-README.md:22]** Undefined acronym "BGE" may confuse newcomers
- **[AK-ACRONYM-DEBUG-README.md:520]** Undefined acronym "DEBUG" may confuse newcomers
- **[AK-ACRONYM-LICENSE-README.md:647]** Undefined acronym "LICENSE" may confuse newcomers
...
---
*quaid-scanner v0.1.2 | 2026-06-01T20:57:17.987Z*
*Commit: 28b40e6c18f69a04a38a2222876c20b59befec61*